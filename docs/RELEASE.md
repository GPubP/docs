...
| 4.8.1.b 	| Niet kritieke services      	| 31 oktober 07:55 uur  	| geen                                                                                                                                                         	| <ul><li>downtime enkele seconden</li><li>Bynder: Geen afbeeldingen uit bynder kunnen halen Forms: Geen nieuwe form referenties kunnen leggen in content</li><ul> 	|
| 4.8.1.c 	| Navigatie & taxonomy        	| 2 november 07:55 uur  	| <ul><li>downtime max 1 minuut</li><li>geen taxonomie en navigatie data ophalen/bewerken</li><li>recovery max 1 min</li></ul>                                	| <ul><li>redactie 1 uur onbeschikbaar</li><li>recovery 1 min</li></ul>                                                              	|
| 4.8.1.d 	| Assets & translations       	| 7 november 07:55 uur  	| <ul><li>downtime max 1 minuut</li><li>geen afbeeldingen en bijlagen kunnen ophalen</li><li>recovery max 1 min</li></ul>                                     	| <ul><li>redactie 1 uur onbeschikbaar</li><li>recovery max 1 min</li></ul>                                                              	|
| 4.8.1.e 	| Content                     	| 8 november 07:55 uur  	| <ul><li>downtime max 1 minuut</li><li>geen content kunnen ophalen</li><li>recovery max 1 min</li></ul>                                                      	| <ul><li>redactie 2 uur onbeschikbaar</li><li>recovery max 1 min</li></ul>                                                              	|
| 4.8.1.f 	| Workflow & Sites            	| 9 november 07:55 uur  	| <ul><li>downtime max 1 minuut</li><li>geen content kunnen ophalen</li><li>recovery max 1 min</li></ul>                                                      	| <ul><li>redactie 1 uur onbeschikbaar</li><li>recovery max 1 min</li></ul>                                                              	|
| 4.8.1.g 	| Search & Sockets            	| 14 november 07:55 uur 	| geen                                                                                                                                                         	| <ul><li>max 1 min niet beschikbaar</li><li>geen nieuwe search inrichtingen kunnen opzetten mogelijks herindexatie nodig</li><li>recovery max 1 min</li></ul>        	|
| 4.8.1.h 	| BRaaS                       	| 15 november 07:55 uur 	| geen                                                                                                                                                         	| <ul><li>max 1 min niet beschikbaar</li><li>mogelijks Not Allowed Errors Na de switch best opnieuw aanmelden</li><li>recovery max 1 min</li></ul>                    	|
| 4.8.1.i 	| Core services               	| 16 november 07:55 uur 	| <ul><li>downtime max 1 minuut</li><li>geen taxonomie, navigatie data, content, afbeeldingen, bijlagen ophalen/bewerken</li><li>recovery max 1 min</li></ul> 	| <ul><li>redactie 1 uur onbeschikbaar</li><li>recovery max 1 min</li></ul>                                                              	|
| 4.8.1.j 	| Yapla modules               	| 21 november 07:55 uur 	| TBD                                                                                                                                                          	| TBD                                                                                                                                                             	|
