...
De rechten van de gebruiker binnen de tenant worden ingeregeld in **BraaS**. Zonder permissies in BraaS, kan het dus zijn dat een gebruiker kan aanmelden en een tenant kan zien op de landingspagina van de redactie, maar dat de tenant bij doorklikken niet geladen kan worden.
...
Om iemand tenant beheerder te maken, dien je de gebruiker, nadat deze werd toegevoegd aan het tenant team, de business rol van tenant beheerder toe te kennen in BraaS. Deze rol kan immers niet toegekend worden via de redactieomgeving.
